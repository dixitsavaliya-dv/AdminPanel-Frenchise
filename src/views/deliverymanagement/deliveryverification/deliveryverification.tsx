...
class DeliveryVerification extends React.Component<{ history: any }> {
  state = {
    count: 10,
    currentPage: 1,
    items_per_page: 2,
  ...
  async componentDidMount() {
    document.title = constant.deliveryVerification + utils.getAppName();
  ...
  edituser() {
    this.props.history.push("/edit-delivery-verification");
  }

  viewuser() {
    this.props.history.push("/view-delivery-verification");
  }
  ...
  deleteuser() {
    Swal.fire({
      title: "Are you sure?",
      text: "You should be remove delivery verification!",
      icon: "warning",
      ...
      if (result.value) {
        ...
        const msg = "Delivery Verification has been deleted";
        // utils.showSuccess(msg);
        // this.componentDidMount();
      } else if (result.dismiss === Swal.DismissReason.cancel) {
        const msg1 = "Delivery Verification is safe :";
                  ...
                  <CardHeader>
                    <Row>
                      <Col xs="12" sm="12" md="6" lg="6" xl="6">
                        <CardTitle className="font">Delivery Verification Management</CardTitle>
                      </Col>
                      <Col xs="12" sm="12" md="6" lg="6" xl="6">
                        <div className="right">
                          <Link to="/add-delivery-verification">
                            <Button
