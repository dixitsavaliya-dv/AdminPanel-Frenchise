...
class Products extends React.Component<{ history: any }> {
    ...
    async componentDidMount() {
        document.title = constant.product + utils.getAppName();
    ...
    deleteCategory() {
        Swal.fire({
            title: 'Are you sure?',
            text: 'You should be remove product!',
            icon: 'warning',
            ...
            if (result.value) {
                ...
                const msg = "Your product has been deleted";
                // utils.showSuccess(msg);
                // this.componentDidMount();
            } else if (result.dismiss === Swal.DismissReason.cancel) {
                const msg1 = "product is safe :";
