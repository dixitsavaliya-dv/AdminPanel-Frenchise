...
class RatingMaster extends React.Component<{ history: any }> {
  state = {
    count: 10,
    currentPage: 1,
    items_per_page: 2,
  ...
  async componentDidMount() {
    document.title = constant.ratingMaster + utils.getAppName();
  ...
  viewuser() {
    this.props.history.push("/view-rating-master");
  }
